...
urlpatterns = [
    ...
    path('new_shaker/gifts_of_all_users/<str:pk>/', views.gifts_of_all_users, name="gifts_of_all_users"),
    path('new_shaker/gifts_of_shaked_user/<str:pk>/', views.gifts_of_shaked_users, name="gifts_of_shaked_users"),
